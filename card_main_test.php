<?php
require_once __DIR__ . "/sendCardWeixin1.class.php";
function get_db() {
	$pdo = new PDO(
...
*/
$info = "56651\r\n126974,192.168.1.155,20171103140613,15,1,3829,250,3579,14431,38,0,5200817081401452,155\r\n126974,192.168.1.155,20171103114209,15,1,4029,200,3829,14428,37,0,5200817081401452,155\r\n";
$db = get_db();
main($info, $db);
