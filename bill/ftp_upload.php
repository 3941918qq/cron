...
class class_ftp
{
    ...
    const FTP_HOST='60.205.148.191';
    const FTP_PORT='5001';
    const FTP_USER='administrator';
    const FTP_PASS='zdyfy@jm1688';
    /**
    * 方法：FTP连接
    * @FTP_HOST -- FTP主机
    * @FTP_PORT -- 端口
    ...
    * @type -- 若目标目录不存在则新建
     ...
     */
     ...
     //$ftp = new class_ftp(); // 打开FTP连接
     //$ftp->up_file('./20180312510102180306020203.txt','20180312510102180306020203.txt'); //上传文件
